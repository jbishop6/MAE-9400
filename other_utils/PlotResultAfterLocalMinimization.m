function PlotResultAfterLocalMinimization(V1,F1,V2,F2,idx1,idx2,title1,title2, fig_save_name, fig_path)
%figure
colorVerts = V1(:,idx1)';
...
%% saving
savefilename = fig_save_name;
% disp(fig_save_name)
% disp(fig_path)
saveas(gca, fullfile(fig_path, savefilename), 'fig');
